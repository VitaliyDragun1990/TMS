...
public class DeleteTimetableResourceTest {
    ...
    void shouldReturnStatusBadReqeustIfProvidedTimetableIdentifierIsNotNumber() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(delete("/api/v1/timetables/{timetableId}", invalidId)
                .locale(Locale.US))
    ...
    void shouldReturnStatusBadRequestIfProvidedTimetableIdentifierIsNotValid() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(delete("/api/v1/timetables/{timetableId}", negativeId)
                .locale(Locale.US))
                .andExpect(status().isBadRequest())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    ...
    void shouldReturnStatusNotFoundIfNoTimetableWithProvidedIdentifierExist() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(delete("/api/v1/timetables/{timetableId}", TIMETABLE_ID)
                .locale(Locale.US))
