...
public class DeleteStudentResourceTest {
    ...
    void shouldReturnStatusBadRequestIfProvidedStudentIdentifierIsNotNumber() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(delete("/api/v1/students/{studentId}", invalidId)
                .locale(Locale.US))
    ...
    void shouldReturnStatusBadRequestIfProvidedStudentIdentifierIsNotValid() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(delete("/api/v1/students/{studentId}", negativeId)
                .locale(Locale.US))
                .andExpect(status().isBadRequest())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    ...
    void shouldReturnStatusNotFoundIfNoStudentWithProvidedIdentifierExist() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(delete("/api/v1/students/{studentId}", studentId)
                .locale(Locale.US))
