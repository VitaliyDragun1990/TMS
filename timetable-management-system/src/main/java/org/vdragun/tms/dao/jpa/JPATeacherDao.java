 ...
 */
@Repository
public class JPATeacherDao extends BaseJPADao implements TeacherDao {

    public JPATeacherDao(EntityManagerFactory factory) {
        super(factory);
    }
    ...
    public void save(Teacher teacher) {
        ...
        execute(entityManager -> entityManager.persist(teacher));
    }
